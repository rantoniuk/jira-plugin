...
public class JiraRestService {
    ...
    public List<Issue> getIssuesFromJqlSearch(String jqlSearch, Integer maxResults) throws RestClientException {
        ...
        try {
            ...
            Thread.currentThread().interrupt();
            LOGGER.log(
                    WARNING, e, () -> "[Jira] Jira REST client get issue from jql search error. cause: " + e.getMessage());
            throw new RestClientException(
    ...
    public Version addVersion(String projectKey, String versionName) {
        ...
        try {
            ...
            throw new RestClientException(
                    "[Jira] Jira REST client add version error. cause: " + e.getMessage(), e);
        } catch (RestClientException | ExecutionException | TimeoutException e) {
            LOGGER.log(WARNING, e, () -> "[Jira] Jira REST client add version error. cause: " + e.getMessage());
            throw new RestClientException(
                    "[Jira] Jira REST client add version error. cause: " + e.getMessage(), e);
    ...
    public Issue progressWorkflowAction(String issueKey, Integer actionId) {
        ...
        try {
            ...
            Thread.currentThread().interrupt();
            LOGGER.log(
                    WARNING, e, () -> "[Jira] Jira REST client process workflow action error. cause: " + e.getMessage());
            throw new RestClientException(
    ...
    public List<Transition> getAvailableActions(String issueKey) {
        ...
        try {
            ...
            Thread.currentThread().interrupt();
            LOGGER.log(WARNING, e, () -> "[Jira] Jira REST client get available actions error. cause: " + e.getMessage());
            throw new RestClientException(
